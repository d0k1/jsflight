...
// To be really sure what target element was, it may be useful to hold the whole path to target element
...
/**
 * Init method. should be called on host page.
 * uses onload and onbeforeunload mechanics to add/remove event listeners
