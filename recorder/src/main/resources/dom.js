...
/**
 * @Deprecated Use native Firefox function
 *             node.getElementsByClassName(classes)[0]
 */
...
Dom.getElementsByAttribute = function(node, attrName, attrValue)
{
    function escape(string)
    {
        ...
        // xxxsz: Firefox 31 added support for CSS.escape() (See
		// https://bugzil.la/955860)
        // So the check and the code afterwards can be removed as soon as
		// Firefox 31 is the
 ...
 * 
 * @param node
 *            Node for which to get the index
 * @param [allNodes]
 *            specifies whether all node types or only elements should be
 *            considered
...
/**
 * @return {@Boolean} true if the given element is currently attached to the
 *         document.
 */
...
Dom.DOMMemberTester = function(object)
{
    ...
    // arrays and plain objects (which will become Xrays in bug 987163 and bug
	// 987111,
    // respectively).
    ...
    this.isDOMMember = function(propName)
    {
        try
        {
            ...
            // Special case for window objects, which have built-in properties
			// that are
            ...
            // Verify that the property value matches what's on
			// Object.prototype, to
